          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{ route('visits.index') }}" class="menu-link" target="_blank">
                    <div class="text-truncate" data-i18n="Basic">Visits</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('appointments.index') }}" class="menu-link" target="_blank">
                    <div class="text-truncate" data-i18n="Basic">Appointments </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('birth_reports.index') }}" class="menu-link" target="_blank">
                    <div class="text-truncate" data-i18n="Basic">Birth Reports </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('lab_orders.index') }}" class="menu-link" target="_blank">
                    <div class="text-truncate" data-i18n="Basic">Lab Orders  </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('lab_results.index') }}" class="menu-link" target="_blank">
